...
local Library = {
    ...
    FontColor = Color3.fromRGB(206, 207, 233);
    MainColor = Color3.fromRGB(25, 26, 32);
    BackgroundColor = Color3.fromRGB(26, 28, 34);
    AccentColor = Color3.fromRGB(136, 156, 195);
    OutlineColor = Color3.fromRGB(56, 55, 70);
